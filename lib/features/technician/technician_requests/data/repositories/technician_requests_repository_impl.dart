...
import 'package:car_care/features/technician/technician_requests/data/models/request_model.dart' as request_model;
import 'package:car_care/features/technician/technician_requests/domain/maper/available_map.dart';
import 'package:dartz/dartz.dart';

import '../../domain/entities/available_requests_entity.dart' hide CustomerEntity, VehicleEntity, ImageEntity;
import '../../domain/entities/request_entity.dart' ;
import '../../domain/repositories/i_technician_requests_repository.dart';
import '../data_sources/technician_requests_remote_data_source.dart';



class TechnicianRequestsRepositoryImpl implements ITechnicianRequestsRepository {
  final TechnicianRequestsRemoteDataSource _remoteDataSource;

  TechnicianRequestsRepositoryImpl(this._remoteDataSource);
