...
import 'package:car_care/features/technician/technician_order/data/models/available_requests_model.dart';
import 'package:car_care/features/technician/technician_order/data/models/request_model.dart';

class TechnicianOrderRemoteDataSource {

  const TechnicianOrderRemoteDataSource(this._apiService);
