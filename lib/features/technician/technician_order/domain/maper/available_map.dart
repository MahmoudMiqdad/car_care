...
AvailableRequestsEntity mapAvailable(
  available_model.AvailableRequestsModel model,
) {
  return AvailableRequestsEntity(
    ...
    data: model.data
        .map(
          (item) => AvailableRequestDataEntity(
            id: item.id,
            ...
            images: item.images
                .map((img) => ImageEntity(id: img.id, url: img.url))
                .toList(),
