...
class TechnicianProfileBody extends StatefulWidget {
  ...
  @override
  State<TechnicianProfileBody> createState() =>
      _TechnicianProfileBodyState();
}

class _TechnicianProfileBodyState
    extends State<TechnicianProfileBody> {
  ...
  Widget build(BuildContext context) {
    ...
    return BlocConsumer<TechnicianProfileCubit,
      ...
      builder: (context, state) {
        final isLoading =
            state is TechnicianProfileLoading;
          ...
          child: Column(
            ...
            children: [
              ...
              LoginTextField(
                ...
                hintText: 'التخصص',
                iconPath:
                    'assets/images/icons8-work-50.png',
              ),
              ...
              LoginTextField(
                ...
                iconPath:
                    'assets/images/icons8-certificate-72.png',
                          ...
                          for (int i = 0;
                              i <
                                  _certificationImages
                                      .length;
                              i++) {
                            params["certifications[$i]"] =
                                File(_certificationImages[i]
                                    .path).path;
                          }
