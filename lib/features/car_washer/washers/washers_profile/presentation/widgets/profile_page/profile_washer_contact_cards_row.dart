      ...
      child: _ProfileWasherTealBorderCard(
        child: _ContactCardInnerRow(
          ...
          body: Text(
            ...
            style: AppTextStyles.font15TextPrimarySemiBold(context),
          ),
        ),
      ),
    );
        ...
        child: _ContactCardInnerRow(
          ...
          body: Column(
            ...
            children: [
              Text(
                l10n.washerOpenTime(
                  formatWasherTime12Hour(context, workStart),
                ),
                maxLines: 1,
                overflow: TextOverflow.ellipsis,
                style: AppTextStyles.font13TextPrimarySemiBold(context),
              ),
              Text(
                l10n.washerCloseTime(
                  formatWasherTime12Hour(context, workEnd),
                ),
                maxLines: 1,
                overflow: TextOverflow.ellipsis,
                style: AppTextStyles.font13TextPrimarySemiBold(context),
