...
String? validateFuelProviderCancellationReason(BuildContext context, String? value) {
                          ...
                          : () async {
                              ...
                              try {
                                ...
                                if (result != null &&
                                  ...
                                  context.read<FuelProviderOrderCubit>().acceptOrder(
                                        order.id!,
                      ...
                      onCancelOrder: order.id != null
                          ? () async {
                              final reason = await showCancelReasonDialog(
                                ...
                                question: l10n.pleaseEnterCancellationReason,
                              );
